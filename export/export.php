...
require "../config/db.php";
     ...
     fputcsv($output, array('Student Name', 'Admission NO', 'Course Code', 'Subject', 'Session', 'Test', 'Objective', 'Theory'));  
     $query = "SELECT fullname, adm_no, course_code, subject, session, test, obj_score, essay_score FROM $answer_sheet WHERE teacher='$teacher'";  
 ...
 $output = fopen("php://output", "w");  
 fputcsv($output, array('Student Name', 'Admission NO', 'Class', 'Term', 'Session', 'No Absent', 'No Present',
