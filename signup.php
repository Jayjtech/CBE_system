            ...
            <div class="col-lg-9" style="margin:0 auto;">
              ...
              <?php endif ?>
                <div class="row">
                    ...
                    <div class="col-lg-6 form-group">
                        <input type="file" id="p_img" style="width:100%;" name="p_image"  required class="btn btn-primary" 
                        accept="jpg, jpeg, png" onchange="previewImage();" value="<?php echo $bg_image?>" />     
                    </div>
                    <div class="col-lg-6 form-group">
                        <input type="text" name="fullname" value="<?php echo $fullname; ?>"
                        placeholder="Full Name..." class="form-control form-control-lg">
                    </div>
                    <div class="col-lg-6 form-group">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        placeholder="Phone No..." class="form-control form-control-lg">
                    </div>
