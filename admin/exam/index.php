...
$res = $conn->query("SELECT * FROM $answer_sheet where class='$my_class' AND course_code='$course_code'");
     ...
     <div class="header">
        ...
        <hr><br><br>
            ...
            <ul>
                ...
                <li><strong>Each question carries:</strong> <?php echo $unit_score; ?> <?php if($unit_score == 1){echo "Mark";}else{echo "Marks";}?></li>
                <li><strong>Estimated Time:</strong> <?php echo $duration;?> <?php if($duration == 1){echo "minute";}else{echo "minutes";}?></li>
