                ...
                ?>
                    <div class="row">
                        <div class="container col-lg-6">
                            ...
                            <img src="<?php echo $question_img; ?>" style="<?php if ($question['text'] != "") {
                                                                                echo "width:90%;height:30%;";
                                                                            } else {
                    ...
                    <form action="exam_pro.php" method="post" class="<?php if ($question_img !== "") {
                                                                            echo "col-lg-6 mt-5";
                                                                        } ?>">
                        <ul>
        ...
        WHERE course_code='$course_code' AND session='$current_session' AND class='$my_class' ORDER BY question_number ASC");
                            ...
                            ?>
                                ...
                                <div class="question_nav" style="border-left:none; margin-left:-8px;">
                                    ...
                                    $alphabet = $conn->query("SELECT * FROM $answer_sheet WHERE username='$username'AND adm_no='$adm_no' AND course_code='$course_code'AND session = '$session'");
